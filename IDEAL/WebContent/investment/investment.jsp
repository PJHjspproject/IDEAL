...
function checkinput() {
	...
	if(parseInt(document.fr.InvestMoney.value) > parseInt(document.fr.impInvestMoney.value)){
		alert("투자가능 금액 보다 높은 금액은 투자하실 수 없습니다.");
		alert(document.fr.InvestMoney.value);
		alert(document.fr.impInvestMoney.value);
		document.fr.InvestMoney.focus();	
		return false;
	}
